...
public class iPadTestRemote {

  private WebDriver driver = null;

  @Before
  public void createDriver() throws Exception {
	driver = new RemoteWebDriver(DesiredCapabilities.ipad());
//	driver = new RemoteWebDriver(new URL("http://10.0.6.135:3001/wd/hub"), DesiredCapabilities.ipad());
...
//	WebDriver driver = new IPhoneDriver();
  ...
  public void shouldBeAbleToPerformAGoogleSearch() {
    ...
    try {
		FileUtils.copyFile(srcFile, new File("./screenshots/ipadsimulator/test003.png"));
	} catch (IOException e) {
