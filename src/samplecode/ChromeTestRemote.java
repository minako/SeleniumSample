...
//	  caps.setCapability("version", "9");
	  //need to specify remote address, not to executeon localhost.
    driver = new RemoteWebDriver(new URL("http://10.0.6.186:5555/wd/hub"), caps);
  ...
  public void shouldBeAbleToPerformAGoogleSearch() {
    ...
    try {
		FileUtils.copyFile(srcFile, new File("./screenshots/chrome/test003.png"));
	} catch (IOException e) {
